...
async function run_state_machine () {
  ...
  .start();
  datdot_service.send({ type: 'SETUP_ATTEST', key: id++ })
  datdot_service.send({ type: 'SETUP_ATTEST', key: id++ })
  datdot_service.send({ type: 'SETUP_ATTEST', key: id++ })
  datdot_service.send({ type: 'SETUP_ATTEST', key: id++ })
  datdot_service.send({ type: 'SETUP_ATTEST', key: id++ })
  datdot_service.send({ type: 'SETUP_ENCODE', key: id++ })
  datdot_service.send({ type: 'SETUP_ENCODE', key: id++ })

  datdot_service.send({ type: 'RESOLVE', key: '1' })
  datdot_service.send({ type: 'RESOLVE', key: '1' })
  datdot_service.send({ type: 'RESOLVE', key: '1' })
  datdot_service.send({ type: 'RESOLVE', key: '1' })

  datdot_service.send({ type: 'RESOLVE', key: '2' })
  datdot_service.send({ type: 'RESOLVE', key: '2' })
  datdot_service.send({ type: 'RESOLVE', key: '2' })
  datdot_service.send({ type: 'RESOLVE', key: '2' })
