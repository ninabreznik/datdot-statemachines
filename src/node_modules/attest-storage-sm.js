...
module.exports = Machine({
  ...
  services: {
    connect_to_hoster: new Promise((resolve, reject) => { setTimeout(() => { resolve('connected') }, 3000) }),
    get_and_verify_data: new Promise((resolve, reject) => { setTimeout(() => { resolve('verified') }, 3000) }),
