...
module.exports = Machine({
  ...
  states: {
    subscribing: {
      invoke: {
        id: 'subscribe', src: 'subscribe_to_hosting_plan',
        onDone: {
          target: 'active',
    ...
    active: {
      entry: () => console.log('plan-sm: active hosting_state') ,
      on: {
        PLAN_UPDATE: {
          target: 'updating'
        },
  ...
  services: {
    ...
    update_hosting_plan: new Promise((resolve, reject) => { setTimeout(() => { resolve('updated') }, 3000) }),
    ...
    publish_to_chain: new Promise((resolve, reject) => { setTimeout(() => { resolve('reported') }, 3000) }),
  }
})
